...
class DetailFragment : Fragment(R.layout.fragment_detail) {
    ...
    private fun updateTabs(summaryBtn: MaterialButton, fileBtn: MaterialButton) {
        ...
        if (isSummaryTab) {
            ...
            fileBtn.setBackgroundColor(resources.getColor(R.color.color_background, null))
            fileBtn.setTextColor(resources.getColor(R.color.color_text_secondary, null))
            ...
            summaryBtn.setBackgroundColor(resources.getColor(R.color.color_background, null))
            summaryBtn.setTextColor(resources.getColor(R.color.color_text_secondary, null))
        }
    }
