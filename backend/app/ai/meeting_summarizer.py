...
def _build_common_rules() -> str:
    ...
    return (
        ...
        "요약 기준:\n"
        '- summary는 전체 회의 내용을 5~8문장 이내의 자연스러운 한 문단으로 작성하세요.\n'
        '- summary의 첫 문장은 회의의 주제나 목적을 간단히 제시하세요.\n'
        '- 이어서 핵심 논의 내용, 주요 쟁점, 결정된 방향, 후속 작업을 2~4문장으로 압축하세요.\n'
        '- 마지막 문장은 회의의 결론, 의미, 다음 단계 중 가장 중요한 내용을 정리하세요.\n'
        '- 단순히 "A가 B를 맡았다"를 나열하지 말고, 회의에서 무엇을 논의했고 어떤 방향으로 정리되었는지 중심으로 작성하세요.\n'
        '- 역할 분담은 필요한 경우에만 summary에 포함하고, 상세 작업은 action_items에 분리하세요.\n'
